    ...
    <div class="content p">
      ...
      <div class="card comments">
        ...
        <div class="comment">
          <header>
            <img
              :src="_checkImgUrl('2S9bbgb-Sf2kIdSTxoeTw.png')"
              alt=""
              class="avatar"
            />
          ...
          <div class="w">
            ...
            <img
              :src="_checkImgUrl('NYEfuYS-LVZ620UYgQNAM.png')"
              alt=""
              class="avatar"
            />
          </div>
        ...
        <div class="comment">
          <header>
            <img
              :src="_checkImgUrl('9Tx6cZkUOoHqPkbETUZ5Y.png')"
              alt=""
              class="avatar"
            />
            <span class="gray">花***栽</span>
          ...
          <div class="w">
            ...
            <img
              :src="_checkImgUrl('2b2rpive_RVzDrYgo-F9K.png')"
              alt=""
              class="avatar"
            />
          </div>
      ...
      <div class="card shop">
        <header>
          <img
            :src="_checkImgUrl('LJ-8p2jF3HydBD5j28PgQ.png')"
            alt=""
            class="avatar"
          />
          <div class="right">
        ...
        <div class="recommend">
          ...
          <div class="wrap">
            <div class="item">
              <img
                :src="_checkImgUrl('/goods/g6-0.jpg')"
                alt=""
                class="avatar"
              />
            ...
            <div class="item">
              <img
                :src="_checkImgUrl('/goods/g1-0.jpg')"
                alt=""
                class="avatar"
              />
              <div class="name">
            ...
            <div class="item">
              <img
                :src="_checkImgUrl('/goods/g2-0.webp')"
                alt=""
                class="avatar"
              />
              <div class="name">
            ...
            <div class="item">
              <img
                :src="_checkImgUrl('/goods/g3-0.jpg')"
                alt=""
                class="avatar"
              />
              <div class="name">
