  ...
  <div class="Share2Friend">
          ...
          <div class="desc">
            ...
            <span class="account" v-if="item.account">
              ...
              <span v-if="item.account.indexOf(searchKey) > -1">
                ...
                >{{
                  item.account.substr(
                    item.account.indexOf(searchKey) + searchKey.length,
                  )
                }}
              </span>
    ...
    >
      <div class="list">
        ...
        <div
          class="local-row"
          v-for="item of friends.eachOther"
          @click="toggleSelect(item)"
        >
          <Check mode="red" v-model="item.select" />
          <img :src="$imgPreview(item.avatar)" alt="" />
      ...
      <div
        class="share2friend"
        v-if="selectFriends.length && searchResult.length"
      >
        <div class="comment">
