      ...
      <Scroll ref="mainScroll">
        ...
        <div class="messages">
          ...
          <div class="message" @click="$nav('/message/fans')">
            <div class="avatar">
              <img
                src="../../assets/img/icon/msg-icon1.png"
                alt=""
                class="head-image"
              />
            </div>
          ...
          <div class="message" @click="$nav('/message/all')">
            <div class="avatar">
              <img
                src="../../assets/img/icon/msg-icon2.png"
                alt=""
                class="head-image"
              />
            </div>
          ...
          <div class="message" @click="$nav('/message/system-notice')">
            <div class="avatar">
              <img
                src="../../assets/img/icon/msg-icon4.png"
                alt=""
                class="head-image"
              />
            </div>
            ...
            <div class="search-result" v-if="searchFriends.length">
              ...
              >
                ...
                <div class="right">
                  ...
                  <img
                    v-if="item.select"
                    src="../../assets/img/icon/message/checked.png"
                    alt=""
                  />
                  <img
                    v-if="!item.select"
      ...
      <div class="more-chat">
        <template v-if="searchKey">
          ...
          <div
            ...
            @click="$nav('/home/search', { key: searchKey })"
          >
            <img
              class="icon"
            ...
            <div class="right">
              <div class="left">
                ...
                >
                <span class="second-text-color f12"
                  >视频、用户、音乐、话题、地点等</span
                >
              </div>
    ...
    computed: {
      ...
      searchFriendsAll() {
        return this.friends.all.filter((v) => {
          return (
            v.name.search(this.searchKey) !== -1 ||
            v.account.search(this.searchKey) !== -1
          )
        })
      },
    },
