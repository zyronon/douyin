      ...
      >
        <div class="messages">
          <div class="message" @click="$nav('/message/visitors')">
            <div class="left">
              <img
                v-lazy="_checkImgUrl(userinfo.cover_url[0].url_list[0])"
                alt=""
                class="avatar"
              />
            </div>
          ...
          <div class="message" v-for="item in showMessageList" @click="$no">
            <div class="left">
              <img
                v-lazy="$imgPreview(item.author.avatar)"
                alt=""
                class="avatar"
              />
              <img
            ...
            <div class="right">
              <div class="desc">
                ...
                <div class="desc-content">
                  ...
                  <span v-if="selectShowType === 3"
                    >@{{ userinfo.nickname }}</span
                  >
                  <span v-if="selectShowType === 4">好好看啊</span>
                </div>
                <div class="bottom">
                  <div class="type" v-if="selectShowType === 3">
                    在评论中提到了你
                  </div>
                  <div class="type" v-if="selectShowType === 4">
                    回复了你的评论
                  </div>
                  <div class="time">01-11</div>
                </div>
