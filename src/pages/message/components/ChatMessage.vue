      ...
      <div class="chat-wrapper" @click="$emit('itemClick', message)">
        ...
        >
          ...
          <div class="author">
            <img
              class="video-avatar"
              :src="message.data.author.avatar"
              alt=""
            />
        ...
        <div
          class="call"
          v-if="
            message.type === MESSAGE_TYPE.VIDEO_CALL ||
        ...
        >
          ...
          <div
            class="reject"
            v-if="
              message.state === CALL_STATE.REJECT ||
          ...
          >
            ...
            />
            <div class="notice">
              <span class="state" v-if="message.state === CALL_STATE.REJECT"
                >对方已拒绝</span
              >
              <span class="state" v-if="message.state === CALL_STATE.NONE"
                >对方未接通</span
              >
              <span>点击呼叫</span>
            </div>
        ...
        >
          <div class="top">
            <img
              src="../../../assets/img/icon/message/chat/redpack-logo.webp"
              alt=""
            />
            <div class="right">
              <div class="title">{{ message.data.title }}</div>
